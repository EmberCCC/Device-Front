 ...
 * @LastEditTime: 2022-08-02 13:41:14
...
export const Link_item = ({value,onChange,...rest}) => {
    ...
    return (
        <div style={{display:'flex',flexDirection:'column',width:'100%'}}>
            {
                addons.dependValues[0] == '1' || addons.dependValues[0] == undefined && addons.formData.$id.substring(2,3) == 0 &&
                <Input onChange={handleInput} defaultValue={addons.formData.default}/>
            }
            {
                addons.dependValues[0] == '1' || addons.dependValues[0] == undefined && addons.formData.$id.substring(2,3) == 1 &&
