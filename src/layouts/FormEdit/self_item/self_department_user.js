...
const Self_department_user = observer((props) => {
    ...
    return (
        <div style={{ width: '100%' }} >
            ...
            <User_choose disabled={schema.disabled} handleUpdate={handleUpdate} mode={schema.self_setting?.mul} initUserList={props.value == undefined ? [] : props.value} initChooseList={schema?.self_setting?.scope} />
        </div>
    );
})
