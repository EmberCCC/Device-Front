 ...
 * @LastEditTime: 2022-07-19 06:46:01
...
const Mul_Tag = observer(({ FormStore, value, onChange, ...rest }) => {
    const { checked, subFormName, schemaList } = FormStore
    ...
    return (
        <div className="total_tags">
            <div className="tags_title">
                <div>多标签显示</div>
                <Switch onChange={handleChange} style={{ width: '20px' }} defaultChecked={schemaList.length > 0}>多标签显示</Switch>
            </div>
