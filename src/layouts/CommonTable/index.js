 ...
 * @LastEditTime: 2022-04-22 18:48:02
...
class CommonTable extends Component {
  ...
  render() {
    ...
    if (model == 'look') {
      ...
      return <GlobalTabel columns={columns} dataSource={dataSource} PageInfo={PageInfo} firstFormId={firstFormId} loading={isLoading} itemDataT={this.props.HomeStore.itemDataT}
