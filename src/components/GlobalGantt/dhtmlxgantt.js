    ...
    t.exports = {
        copy: function t(e) {
            ...
            if (e && "object" == typeof e) {
                for (a = {},
                n = [Array, Number, String, Boolean], i = 0; i < n.length; i++) e instanceof n[i] && (a = i ? new n[i](e) : new n[i]);
    ...
    t.exports = {
        ...
        getFocusableNodes: function(t) {
            for (var e = t.querySelectorAll(["a[href]", "area[href]", "input", "select", "textarea", "button", "iframe", "object", "embed", "[tabindex]", "[contenteditable]"].join(", ")), i = Array.prototype.slice.call(e, 0), o = 0; o < i.length; o++) {
                var l = i[o]; (r(l) || s(l) || a(l)) && n(l) || (i.splice(o, 1), o--)
            }
            return i
        },
        ...
        getRelativeEventPosition: function(t, e) {
            ...
            i(e));
            return n.x = n.x - a.x + e.scrollLeft,
            n.y = n.y - a.y + e.scrollTop,
            n
        },
...
function(t, e) {
    ...
    t.exports = {
        ...
        forEach: function(t, e) {
            ...
            else for (var i = t.slice(), n = 0; n < i.length; n++) e(i[n], n)
        },
...
function(t, e, i) {
    ...
    s = function() {
        ...
        t.prototype.resize = function(t) {
            ...
            n = e.offsetHeight,
            r = this.getSize();
            e === document.body && (i = document.body.offsetWidth, n = document.body.offsetHeight),
        ...
        t.prototype._setBorders = function(t, e) {
            ...
            "string" == typeof t && (t = [t]);
            var r = {};
            for (n = 0; n < t.length; n++) a.addClassName(i, t[n]),
            r[t[n]] = !0;
            e._currentBorders = r
        },
        ...
        t.prototype._sizeHeader = function() {
            ...
            else e.className = n ? "gantt_layout_header": "gantt_layout_header vertical",
            e.style.width = "auto",
            e.style.transform = "",
            i.style.display = "",
        ...
        var r = {
            ...
            createEditors: function(n) {
                function r(t, e) {
                    ...
                    return r.className = "gantt_grid_editor_placeholder",
                    r.setAttribute(n.$config.item_attribute, t),
                    r.setAttribute("data-column-name", e),
                    r.setAttribute("data-column-index", n.getColumnIndex(e)),
                ...
                o = {
                    ...
                    init: function() {
                        ...
                        var i = this;
                        a.push(s.attachEvent("onIdChange",
                        function(t, e) {
                            i._itemId == t && (i._itemId = e)
                        })),
                        a.push(s.attachEvent("onStoreUpdated",
                        function() {
                    ...
                    show: function(t, i) {
                        ...
                        if (o) {
                            ...
                            n.$grid_data.appendChild(d),
                            l.show(a.id, s, o, d),
                            this._editor = l,
                            this._placeholder = d,
                            this._itemId = a.id,
                            this._columnName = a.columnName,
                            this._editorType = o.type;
                            var c = e.getMapping();
                    ...
                    hide: function() {
                        if (this._itemId) {
                            ...
                            this._placeholder && (this._editor && this._editor.hide(this._placeholder), this._editor = null, this._placeholder.parentNode && this._placeholder.parentNode.removeChild(this._placeholder), this._placeholder = null, this.callEvent("onEditEnd", [{
                                id: t,
                                columnName: i
                            }]))
                        }
                            ...
                            if (s.exists(e)) {
                                ...
                                if (!1 !== this.callEvent("onBeforeSave", [o]) && this._editor.is_valid(o.newValue, o.id, o.columnName, this._placeholder)) {
                                    ...
                                    "auto" != a.map_to ? (r[i] = l, "duration" == i ? r.end_date = t.calculateEndDate(r) : "end_date" == i ? r.start_date = t.calculateEndDate({
                                        ...
                                        duration: -r.duration,
                                        task: r
                                    }) : "start_date" == i && (r.end_date = t.calculateEndDate(r)), s.updateItem(e)) : this._editor.save(e, n.getColumn(i), this._placeholder),
                                    this.callEvent("onSave", [o])
                                }
                                this.hide()
                            }
                        } else this.hide()
                    ...
                    editNextCell: function(t) {
                        ...
                        if (e) {
                            ...
                            var n = this.moveRow(1); (e = this.getFirstCell()) && this.getEditorConfig(e) && this.startEdit(n, e)
                        }
                    },
                    editPrevCell: function(t) {
                        ...
                        if (e) {
                            ...
                            var n = this.moveRow( - 1); (e = this.getLastCell()) && this.getEditorConfig(e) && this.startEdit(n, e)
                        }
                    },
                    moveRow: function(e) {
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        r.prototype.render = function(t) {
            ...
            if (t.options && t.options.length) for (e = 0; e < t.options.length; e++) i += "<option value='" + t.options[e].key + "'>" + t.options[e].label + "</option>";
            return i += "</select></div>"
        },
        r.prototype.set_value = function(t, e, i, n) {
            var r = t.firstChild; ! r._dhx_onchange && n.onchange && (r.onchange = n.onchange, r._dhx_onchange = !0),
    ...
    t.exports = function(t) {
        ...
        function(t) {
            if (t.config.fit_tasks) {
                var e = +t._min_date,
                i = +t._max_date;
                if ( + t._min_date != e || +t._max_date != i) return t.render(),
...
function(t, e, i) {
    ...
    s.prototype = {
        _parseInner: function(t) {
            for (var e = null,
            i = [], n = 0, r = t.length; n < r; n++) e = t[n],
            this.$initItem && (e = this.$initItem(e)),
            this.callEvent("onItemLoading", [e]) && (this.pull.hasOwnProperty(e.id) || (this.fullOrder.push(e.id), i.push(e)), this.pull[e.id] = e);
            return i
        },
        parse: function(t) {
        ...
        updateItem: function(t, e) {
            ...
            this.pull[t] = e,
            this._skip_refresh || (this.callEvent("onAfterUpdate", [e.id, e]), this.callEvent("onStoreUpdated", [e.id, e, "update"]))
        },
        ...
        removeItem: function(t) {
            ...
            this._skip_refresh || (this.filter(), this.callEvent("onAfterDelete", [e.id, e]), this.callEvent("onStoreUpdated", [e.id, e, "delete"]))
        },
        _addItemInner: function(t, e) {
            if (this.exists(t.id)) this.silent(function() {
                ...
                n = i.length; (!r.defined(e) || e < 0) && (e = n),
                e > n && (e = Math.min(i.length, e))
            }
            this.pull[t.id] = t,
            this._skip_refresh || this._updateOrder(function() { - 1 === this.$find(t.id) && this.$insertAt(t.id, e)
            }),
            this.filter()
        },
        ...
        addItem: function(t, e) {
            ...
            !(!this._skip_refresh && !1 === this.callEvent("onBeforeAdd", [t.id, t])) && (this._addItemInner(t, e), this._skip_refresh || (this.callEvent("onAfterAdd", [t.id, t]), this.callEvent("onStoreUpdated", [t.id, t, "add"])), t.id)
        },
        ...
        clearAll: function() {
            ...
            this.visibleOrder = n.$create(),
            this.fullOrder = n.$create(),
            this._skip_refresh || (this.callEvent("onClearAll", []), this.refresh())
        },
        silent: function(t, e) {
    ...
    t.exports = function(t) {
        function e(e, a) {
            if (!t._isAllowedUnscheduledTask(e)) {
                ...
                c == o.types.milestone && o.link_line_width > 1 && (h += 1),
                c == o.types.milestone && (s.left -= Math.round(d / 2), s.width = d);
                var u = document.createElement("div"),
                _ = Math.round(s.width);
                a.$config.item_attribute && u.setAttribute(a.$config.item_attribute, e.id),
                o.show_progress && c != o.types.milestone &&
                function(e, i, n, r, a) {
                    ...
                    l = Math.round(n * s);
                    l = Math.min(n, l),
                    e.progressColor && (o.style.backgroundColor = e.progressColor, o.style.opacity = 1),
                    o.style.width = l + "px",
                ...
                e.textColor && (f.style.color = e.textColor),
                u.appendChild(f);
                var g = function(e, i, n, r) {
                    ...
                    if (t.getTaskType(l.type) == a.types.milestone ? s.push("gantt_milestone") : t.getTaskType(l.type) == a.types.project && s.push("gantt_project"), s.push("gantt_bar_" + t.getTaskType(l.type)), t.isSummaryTask(l) && s.push("gantt_dependent_task"), t.isSplitTask(l) && s.push("gantt_split_parent"), a.select_task && n == o.selected_task && s.push("gantt_selected"), n == o.drag_id && (s.push("gantt_drag_" + o.drag_mode), o.touch_drag && s.push("gantt_touch_" + o.drag_mode)), o.link_source_id == n && s.push("gantt_link_source"), o.link_target_id == n && s.push("gantt_link_target"), a.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(l) && s.push("gantt_critical_task"), o.link_landing_area && o.link_target_id && o.link_source_id && o.link_target_id != o.link_source_id) {
                        ...
                        _ = "";
                        _ = u ? h ? "link_start_allow": "link_finish_allow": h ? "link_start_deny": "link_finish_deny",
                        s.push(_)
                    }
                    return s.join(" ")
                } ("gantt_task_line", l.task_class(e.start_date, e.end_date, e), e.id, a); (e.color || e.progressColor || e.textColor) && (g += " gantt_task_inline_color"),
                u.className = g;
                ...
                } (e, o, l)) && u.appendChild(v),
                t._waiAria.setTaskBarAttr(e, u);
                var m = t.getState();
                return t.isReadonly(e) || (o.drag_resize && !t.isSummaryTask(e) && c != o.types.milestone && r(u, "gantt_task_drag", e,
                function(t) {
                    var e = document.createElement("div");
                    return e.className = t,
                    e
                },
                o), o.drag_links && o.show_links && r(u, "gantt_link_control", e,
                function(t) {
                    var e = document.createElement("div");
                    e.className = t,
                    ...
                    var n = !1;
                    return m.link_source_id && o.touch && (n = !0),
        ...
        function r(e, i, n, r, a) {
            var s, o = t.getState(); + n.start_date >= +o.min_date && ((s = r([i, a.rtl ? "task_right": "task_left", "task_start_date"].join(" "))).setAttribute("data-bind-property", "start_date"), e.appendChild(s)),
            +n.end_date <= +o.max_date && ((s = r([i, a.rtl ? "task_left": "task_right", "task_end_date"].join(" "))).setAttribute("data-bind-property", "end_date"), e.appendChild(s))
        }
        return function(i, n) {
...
function(t, e, i) {
    ...
    o.prototype = {
        ...
        setSize: function(t, e) {
            ...
            this.$state.height = e;
            for (var i, n = this.getGridColumns(), r = 0, a = 0, s = n.length; a < s; a++) r += 1 * n[a].width; ! isNaN(r) && this.$config.scrollable || (r = i = this._setColumnsWidth(t + 1)),
        ...
        refresh: function() {
            this.$config.bind && (this.$config.rowStore = this.$gantt.getDatastore(this.$config.bind)),
        ...
        _initEvents: function() {
            ...
            this), this.$grid),
            this._mouseDelegates.delegate("click", "gantt_open", gantt.bind(function(t, e, i) {
                var r = this.$config.rowStore;
                if (!r) return ! 0;
                var a = n.locateAttribute(t, this.$config.item_attribute);
        ...
        _getGridWidthLimits: function() {
            for (var t = this.$getConfig(), e = this.getGridColumns(), i = 0, n = 0, r = 0; r < e.length; r++) i += e[r].min_width ? e[r].min_width: t.min_grid_column_width,
        ...
        _setColumnsWidth: function(t, e) {
            ...
            for (var s = 0,
            o = n.length; s < o; s++) r += 1 * n[s].width;
            if (window.isNaN(r)) {
                this._calculateGridWidth(),
                r = 0;
            ...
            for (s = e + 1; s < n.length; s++) {
                ...
                l < 0 ? c.min_width && c.width + h < c.min_width ? h = c.min_width - c.width: !c.min_width && i.min_grid_column_width && c.width + h < i.min_grid_column_width && (h = i.min_grid_column_width - c.width) : c.max_width && c.width + h > c.max_width && (h = c.max_width - c.width),
                r -= c.width,
                c.width += h,
                l -= h
            }
        ...
        _calculateGridWidth: function() {
            ...
            if (t.autofit || n.length) {
                ...
                if (t.autofit) for (a = 0; a < r.length; a++) {
                    ...
                    r[a] += d,
                    (c = this._getColumnWidth(e[a], t, r[a])) != r[a] && (d = c - r[a], r[a] = c),
                    l -= d
                } else if (n.length) for (a = 0; a < n.length; a++) {
                    d = Math.round(l / (n.length - a));
                    var c, h = n[a];
                    r[h] += d,
                    (c = this._getColumnWidth(e[h], t, r[h])) != r[h] && (d = c - r[h], r[h] = c),
                    l -= d
                }
                ...
                t.grid_width = i,
                u && this.$parent._setContentSize(this.$config.width, this.$config.height)
            }
        },
        ...
        return {
            ...
            setSumWidth: function(t, e, i, n) {
                ...
                if (! (i > r.length - 1 || a <= 0 || n > r.length - 1)) {
                    ...
                    this.adjustSize(s, r, i, n),
                    this.adjustSize( - s, r, n + 1),
            ...
            prepareConfigs: function(t, e, i, n, r, a, s) {
                ...
                for (c = 0; c < d.length; c++) s && this.reverseScale(d[c]),
                this.setPosSettings(d[c]);
                return d
            },
            reverseScale: function(t) {
                ...
                t.rtl = !0;
                for (var i = 0; i < t.trace_x.length; i++) t.trace_indexes[t.trace_x[i].valueOf()] = i,
                t.trace_index_transition[e[t.trace_x[i].valueOf()]] = i;
                return t
            },
            setPosSettings: function(t) {
                for (var e = 0,
                i = t.trace_x.length; e < i; e++) t.left.push((t.width[e - 1] || 0) + (t.left[e - 1] || 0))
            },
            _ignore_time_config: function(t, n) {
                if (i.config().skip_off_time) {
                    for (var r = !0,
                    a = t,
                    s = 0; s < n.step; s++) s && (a = e.add(t, s, n.unit)),
            ...
            initColSizes: function(t, i, n, r) {
                ...
                t.width = [];
                for (var o = t.ignore_x || {},
                l = 0; l < t.trace_x.length; l++) if (o[t.trace_x[l].valueOf()] || t.display_count == t.count) t.width[l] = 0;
                else {
                    var d = 1;
                    "month" == t.unit && (d = Math.round((e.add(t.trace_x[l], t.step, t.unit) - t.trace_x[l]) / 864e5)),
                    t.width[l] = d
                }
            ...
            initScaleConfig: function(t, e, i) {
                ...
                t);
                return this.eachColumn(t.unit, t.step, e, i,
                function(t) {
                    r.count++,
...
function(t, e, i) {
    ...
    function l(t, e) {
        for (var i, n, r, a = 0,
        s = t.length - 1; a <= s;) if (n = +t[i = Math.floor((a + s) / 2)], r = +t[i - 1], n < e) a = i + 1;
        else {
            if (! (n > e)) {
                for (; + t[i] == +t[i + 1];) i++;
                return i
    ...
    o.prototype = {
        init: function(t) {
            ...
            n = e[this.$config.bindLinks + "_attribute"]; ! i && this.$config.bind && (i = this.$config.bind + "_id"),
        ...
        _attachLayers: function(t) {
            ...
            if (this.$config.bind) {
                ...
                for (var r = this.$config.layers,
                a = 0; r && a < r.length; a++) {
                    "string" == typeof(d = r[a]) && (d = this.$gantt.$ui.layers[d]),
                    "function" == typeof d && (d = {
                        renderer: d
                    }),
                    d.host = this;
                    ...
                    d.expose && (this._taskRenderer = n.getLayer(s))
                }
            ...
            if (this.$config.bindLinks) {
                ...
                for (a = 0; l && a < l.length; a++) {
                    var d;
                    "string" == typeof d && (d = this.$gantt.$ui.layers[d]),
                    (d = l[a]).host = this;
                    var c = o.addLayer(d);
                    this._taskLayers.push(c),
                    l[a].expose && (this._linkRenderer = o.getLayer(c))
                }
            }
        },
        _initStaticBackgroundRender: function() {
            ...
            e = s.create(),
            i = t.$config.rowStore;
            i && (this._staticBgHandler = i.attachEvent("onStoreUpdated",
            function(i, n, r) {
        ...
        _getScaleChunkHtml: function(t, e, i) {
            for (var n = [], r = this.$gantt.$services.templates().scale_row_class, a = 0; a < t.length; a++) {
                ...
                o = r(t[a]);
                o && (s += " " + o),
                n.push('<div class="' + s + '" style="height:' + t[a].height + "px;position:relative;line-height:" + t[a].height + 'px">' + this._prepareScaleHtml(t[a], e, i) + "</div>")
            }
            return n.join("")
        },
        _prepareScaleHtml: function(t, e, i) {
            ...
            s = null,
            o = null,
            d = null; (t.template || t.date) && (o = t.template || this.$gantt.date.date_to_str(t.date));
            var c = 0,
            h = t.count; ! n.smart_scales || isNaN(e) || isNaN(i) || (c = l(t.left, e), h = l(t.left, i) + 1),
            d = t.css ||
            function() {},
            !t.css && n.inherit_scale_class && (d = r.scale_cell_class);
            for (var u = c; u < h && t.trace_x[u]; u++) {
                ...
                k = "";
                if (f) {
                    v = "width:" + f + "px;height:" + g + "px;" + (n.smart_scales ? "position:absolute;left:" + p + "px": ""),
                    k = "gantt_scale_cell" + (u == t.count - 1 ? " gantt_last_cell": ""),
                    (m = d.call(this, s)) && (k += " " + m);
        ...
        dateFromPos: function(t) {
            ...
            var s = 0;
            return a && (s = this._getColumnDuration(e, e.trace_x[i])),
            new Date(e.trace_x[i].valueOf() + Math.round(a * s))
        },
        posFromDate: function(t) {
            ...
            return i == this._tasks.width.length && (r += this._tasks.width[this._tasks.width.length - 1]),
            n && (i < this._tasks.width.length ? r += this._tasks.width[i] * (n % 1) : r += 1),
            Math.round(r)
        },
        ...
        getItemPosition: function(t, e, i) {
            var n, r, a;
            return this._tasks.rtl ? (r = this.posFromDate(e || t.start_date), n = this.posFromDate(i || t.end_date)) : (n = this.posFromDate(e || t.start_date), r = this.posFromDate(i || t.end_date)),
            a = Math.max(r - n, 0),
            {
                left: n,
...
function(t, e, i) {
    ...
    function(t) {
        ...
        e.prototype.autosize = function(t) {
            ...
            r = this.$container;
            e.x && (i.borderBox && (n.width += i.horPaddings), r.style.width = n.width + "px"),
            e.y && (i.borderBox && (n.height += i.vertPaddings), r.style.height = n.height + "px")
        },
        e.prototype.getSize = function() {
            ...
            return d.maxWidth >= 1e5 && (d.maxWidth = n),
            ...
            this._xLayout ? (d.minWidth += this.$config.margin * this.$cells.length || 0, d.minWidth += 2 * this.$config.padding || 0, d.minHeight += 2 * this.$config.padding || 0) : (d.minHeight += this.$config.margin * this.$cells.length || 0, d.minHeight += 2 * this.$config.padding || 0),
            d
        },
        e.prototype._calcFreeSpace = function(t, e, i) {
            ...
            r = e.maxWidth,
            a = t;
            return a ? (a > r && (a = r), a < n && (a = n), this._free -= a) : ((a = Math.floor(this._free / this._gravity * e.gravity)) > r && (a = r, this._free -= a, this._gravity -= e.gravity), a < n && (a = n, this._free -= a, this._gravity -= e.gravity)),
            a
        },
        ...
        e.prototype._configureBorders = function() {
            ...
            for (n = 0; n < e.length; n++) if (!e[n].$config.hidden) {
                var r = n >= i,
                a = ""; ! r && e[n + 1] && "scrollbar" == e[n + 1].$config.view && (this._xLayout ? r = !0 : a = "gantt_layout_cell_border_transparent"),
                this._setBorders(r ? [] : [t, a], e[n])
            }
        },
        e.prototype._updateCellVisibility = function() {
            for (var t, e = this._visibleCells || {},
            i = !this._visibleCells,
            n = {},
            r = 0; r < this._sizes.length; r++) t = this.$cells[r],
        ...
        e.prototype.setSize = function(e, i) {
            ...
            for (var s = 0; s < this._sizes.length; s++) if (! (n = this.$cells[s]).$config.hidden) {
                ...
                s !== this.$cells.length - 1 && (l.style[d] = o + "px", this._free -= o),
                r = this._sizes[s],
            ...
            for (s = 0; s < this.$cells.length; s++) if (! (n = this.$cells[s]).$config.hidden) {
                ...
                var u = void 0,
                _ = void 0;
                this._xLayout ? (u = this._calcSize(r.width, r, !0), _ = i - 2 * a) : (u = e - 2 * a, _ = this._calcSize(r.height, r, !1)),
                n.setSize(u, _)
            }
        },
        e
...
function(t, e, i) {
    ...
    t.exports = function t(e, i) {
        ...
        return {
            ...
            detachAll: function() {
                for (var t = 0; t < r.length; t++) i(r[t].element, r[t].event, r[t].callback, r[t].capture),
                i(r[t].element, r[t].event, r[t].callback, void 0),
                i(r[t].element, r[t].event, r[t].callback, !1),
                i(r[t].element, r[t].event, r[t].callback, !0);
                r = []
            },
            extend: function() {
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        t.init = function(e, i, r) {
            var a;
            i && r && (this.config.start_date = this._min_date = new Date(i), this.config.end_date = this._max_date = new Date(r)),
            this.date.init(),
        ...
        t._reinit = function(i) {
            ...
            this.$layout.attachEvent("onBeforeResize",
            function() {
...
function(t, e) {
    t.exports = function(t) {
        ...
        t._touch_events = function(n, r, a) {
            ...
            h = null,
            u = null,
            _ = 0; _ < i.length; _++) t.eventRemove(i[_][0], i[_][1], i[_][2]); (i = []).push([t.$container, n[0],
            function(i) {
                var n = e();
                if (!a(i) && l) {
                    h && clearTimeout(h);
                    var u = r(i);
                    if (n && (n.drag.id || n.drag.start_drag)) return n.on_mouse_move(u),
            ...
            i.push([this.$container, n[1],
            function(i) {
                if (!a(i)) if (i.touches && i.touches.length > 1) l = !1;
                else {
                    c = r(i),
                    t._locate_css(c, "gantt_hor_scroll") || t._locate_css(c, "gantt_ver_scroll") || (l = !0);
                    var n = e();
                    h = setTimeout(function() {
                        var e = t.locate(c);
                        n && e && !t._locate_css(c, "gantt_link_control") && !t._locate_css(c, "gantt_grid_data") && (n.on_mouse_down(c), n.drag && n.drag.start_drag && (!
                        function(e) {
                        ...
                        } (e), n._start_dnd(c), t._touch_drag = !0, t.refreshTask(e), t._touch_feedback())),
                        h = null
                    },
                    t.config.touch_drag)
                }
            }]),
            i.push([this.$container, n[2],
            function(i) {
                if (!a(i)) {
                    h && clearTimeout(h),
                    t._touch_drag = !1,
                    ...
                    if (s && s.on_mouse_up(n), u && (t.refreshTask(t.locate(u)), u.parentNode && (u.parentNode.removeChild(u), t._touch_feedback())), t._touch_scroll_active = l = d = !1, u = null, c && o) {
                        var _ = new Date;
                        if (_ - o < 500) t.$services.getService("mouseEvents").onDoubleClick(c),
                        f(i);
                        else o = _
                    } else o = new Date
                }
...
function(t, e) {
    function i(t, e) {
        ...
        o[1] && !e.defined(o[1].width) && (o[1].width = s._second_column_width),
        o[2] && !e.defined(o[2].width) && (o[2].width = s._third_column_width);
        ...
        s.config.task_height && (e.config.task_height = s.config.task_height || "full"),
        s._lightbox_template && (e._lightbox_template = s._lightbox_template),
        s._redefine_lightbox_buttons && (e.config.buttons_right = s._redefine_lightbox_buttons.buttons_right, e.config.buttons_left = s._redefine_lightbox_buttons.buttons_left),
        e.resetLightbox()
    }
    t.exports = function(t) {
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        function a(e, i) {
            ...
            i && (n = t.getTaskByTime(), e.allow_root && n.unshift({
                ...
                for (var a = 0; a < e.length; a++) {
                    var s = e[a]; (s.id == n || t.isChildOf(s.id, n) || !1 === r(s.id, s)) && (e.splice(a, 1), a--)
                }
                return e
        ...
        r.prototype.set_value = function(e, i, n, r) {
            ...
            t.form_blocks.select.set_value.apply(t, [o, i, n, r])
        },
        r
    }
},
    ...
    t.exports = function(t) {
        ...
        function a(e, i) {
            ...
            if (t.defined(r[3])) {
                ...
                isNaN(l) && o.hasAttribute("data-value") && (l = parseInt(o.getAttribute("data-value"), 10)),
                a = Math.floor(l / 60),
                s = l % 60
            }
        ...
        r.prototype.set_value = function(e, i, n, r) {
            ...
            this),
            f.onchange = t.bind(m, this),
            "string" == typeof(o = t._resolve_default_mapping(r)) && (o = {
                start_date: o
            }),
            l = n[o.start_date] || new Date,
            d = n[o.end_date] || t.calculateEndDate({
                start_date: l,
                duration: 1,
                task: n
            }),
            ...
            t.form_blocks._fill_lightbox_select(u, 0, l, v, h),
            f.value = c,
            m()
        },
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        a.prototype.set_value = function(t, e, i, r) {
            var a = Array.prototype.slice.call(t.querySelectorAll("input[type=checkbox]")); ! t._dhx_onchange && r.onchange && (t.onchange = r.onchange, t._dhx_onchange = !0),
            n.forEach(a,
            function(t) {
        ...
        a.prototype.get_value = function(t) {
            return n.arrayMap(Array.prototype.slice.call(t.querySelectorAll("input[type=checkbox]:checked")),
            function(t) {
                return t.value
            })
        },
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        r.prototype.render = function(e) {
            ...
            return n += i,
            e.single_date ? (i = t.form_blocks.getTimePicker.call(this, e, !0), n += "<span></span>") : n += "<span style='font-weight:normal; font-size:10pt;'> &nbsp;&ndash;&nbsp; </span>",
            n += i,
            n += "</div>"
        },
        r.prototype.set_value = function(e, i, n, r) {
            ...
            if (a.auto_end_date) for (var l = function() {
                h = new Date(s[o[2]].value, s[o[1]].value, s[o[0]].value, 0, 0),
            ...
            t.form_blocks._fill_lightbox_select(s, 0, h, o, a),
            t.form_blocks._fill_lightbox_select(s, o.size, u, o, a)
        },
        r.prototype.get_value = function(e, i, n) {
            ...
            function l(t, e, i, n) {
                ...
                s = 0;
                return n = n || 0,
                i && (r = parseInt(t[e[3] + n].value, 10), a = Math.floor(r / 60), s = r % 60),
                new Date(t[e[2] + n].value, t[e[1] + n].value, t[e[0] + n].value, a, s)
            }
            return r = l(a, s, o),
...
function(t, e, i) {
    t.exports = function(t) {
        ...
        function u(e, i) {
            var n, r, a = "";
            for (r = 0; r < e.length; r++) n = t.config._migrate_buttons[e[r]] ? t.config._migrate_buttons[e[r]] : e[r],
        ...
        function _(e, i, n) {
            ...
            case "%d":
                ...
                break;
            case "%H:%i":
                for (e._time_format_order[3] = i, e._time_format_order.size++, l = n.first, d = n.date.getDate(), e._time_values = []; l < n.last;) c += "<option value='" + l + "'>" + t.templates.time_picker(n.date) + "</option>",
                e._time_values.push(l),
                n.date.setTime(n.date.valueOf() + 60 * t._get_timepicker_step() * 1e3),
                l = 24 * (n.date.getDate() != d ? 1 : 0) * 60 + 60 * n.date.getHours() + n.date.getMinutes()
            }
            return c
        }
        t._lightbox_methods = {},
        ...
        t.getLightbox = function(e) {
            ...
            this._lightbox && this.getLightboxType() == this.getTaskType(e) || (this._lightbox_type = this.getTaskType(e), i = document.createElement("div"), s = "gantt_cal_light", n = this._is_lightbox_timepicker(), (t.config.wide_form || n) && (s += " gantt_cal_light_wide"), n && (t.config.wide_form = !0, s += " gantt_cal_light_full"), i.className = s, i.style.visibility = "hidden", r = this._lightbox_template, r += u(this.config.buttons_left), r += u(this.config.buttons_right, !0), i.innerHTML = r, t._waiAria.lightboxAttr(i), t.config.drag_lightbox && (i.firstChild.onmousedown = t._ready_to_dnd, i.firstChild.onselectstart = function() {
                return ! 1
            },
            i.firstChild.style.cursor = "pointer", t._init_dnd_events()), document.body.insertBefore(i, document.body.firstChild), this._lightbox = i, a = this._get_typed_lightbox_config(e), r = this._render_sections(a), i.querySelector("div.gantt_cal_larea").innerHTML = r,
            function(e) {
                var i, n, r, a, s, o;
                for (o = 0; o < e.length; o++) i = e[o],
                r = document.getElementById(i.id),
                i.id && r && (n = r.querySelector("label"), (a = r.nextSibling) && (s = a.querySelector("input, select, textarea")) && (s.id = s.id || "input_" + t.uid(), i.inputId = s.id, n.setAttribute("for", i.inputId)))
            } (a), this.resizeLightbox(), this._init_lightbox_events(this), i.style.display = "none", i.style.visibility = "visible"),
            this._lightbox
        },
        ...
        default = function(i, n) {
                if (n.getAttribute("data-dhx-button")) t.callEvent("onLightboxButton", [n.className, n, i]);
                    ...
                    if ( - 1 != s.indexOf("gantt_custom_button")) if ( - 1 != s.indexOf("gantt_custom_button_")) for (r = n.parentNode.getAttribute("data-index"), a = n; a && -1 == e.getClassName(a).indexOf("gantt_cal_lsection");) a = a.parentNode;
                    else r = n.getAttribute("data-index"),
                    a = n.parentNode,
                    n = n.firstChild;
            ...
            function(i) {
                ...
                r = e.getClassName(n);
                return r || (n = n.previousSibling, r = e.getClassName(n)),
                n && r && 0 === r.indexOf("gantt_btn_set") && (n = n.firstChild, r = e.getClassName(n)),
                !(!n || !r) && (t.defined(t.lightbox_events[n.className]) ? t.lightbox_events[n.className] : t.lightbox_events.
            default)(i, n)
            }),
        ...
        t.getLightboxValues = function() {
            ...
            for (var i = this._get_typed_lightbox_config(), n = 0; n < i.length; n++) {
                ...
                if (a) {
                    ...
                    else if ("object" == typeof o) for (var l in o) o[l] && (e[o[l]] = s[l])
                }
            }
            return e
        },
        ...
        t._set_lightbox_values = function(e, i) {
            ...
            a = [];
            t.templates.lightbox_header ? (a.push(""), a.push(t.templates.lightbox_header(n.start_date, n.end_date, n)), r[1].innerHTML = "", r[2].innerHTML = t.templates.lightbox_header(n.start_date, n.end_date, n)) : (a.push(this.templates.task_time(n.start_date, n.end_date, n)), a.push((this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70)), r[1].innerHTML = this.templates.task_time(n.start_date, n.end_date, n), r[2].innerHTML = (this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70)),
            r[1].innerHTML = a[0],
            r[2].innerHTML = a[1],
            ...
            for (var s = this._get_typed_lightbox_config(this.getLightboxType()), o = 0; o < s.length; o++) {
                ...
                if (this.form_blocks[l.type]) {
                    ...
                    c.set_value.call(t, d, u, n, l),
                    l.focus && c.focus.call(t, d)
                }
            }
        ...
        t.getLightboxSection = function(e) {
            ...
            o = {
                ...
                node: s,
                getValue: function(e) {
                    return t.form_blocks[r.type].get_value.call(t, s, e || {},
                    r)
                },
                setValue: function(e, i) {
                    return t.form_blocks[r.type].set_value.call(t, s, e, i || {},
                    r)
                }
            },
        ...
        t.form_blocks = {
            getTimePicker: function(e, i) {
                ...
                t.config.limit_time_select && (d.first = 60 * l.first_hour, d.last = 60 * l.last_hour + 1, d.date.setHours(l.first_hour)), r = 0; r < d.timeFormat.length; r++) r > 0 && (o += " "),
                (a = _(e, r, d)) && (s = t._waiAria.lightboxSelectAttrString(d.timeFormat[r]), o += "<select " + (e.readonly ? "disabled='disabled'": "") + (i ? " style='display:none' ": "") + s + ">" + a + "</select>");
                return o
            },
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        t._set_default_task_timing = function(e) {
            e.start_date = e.start_date || t._defaultTaskDate(e, this.getParent(e)),
            e.duration = e.duration || this.config.duration_step,
            e.end_date = e.end_date || this.calculateEndDate(e)
        },
        t.createTask = function(e, i, n) { (e = e || {},
            t.defined(e.id) || (e.id = t.uid()), e.start_date || (e.start_date = t._defaultTaskDate(e, i)), void 0 === e.text && (e.text = t.locale.labels.new_task), void 0 === e.duration && (e.duration = 1), i) && (this.setParent(e, i, !0), this.getTask(i).$open = !0);
        ...
        t._update_parents = function(e, i) {
            if (e) {
                ...
                if (a.$no_start || a.$no_end) {
                    ...
                    o == n.start_date.valueOf() && l == n.end_date.valueOf() && (s = !1),
        ...
        t.roundDate = function(e) {
            ...
            d = e.unit;
            if (!i) return o;
            if (d == i.unit && l == i.step && +o >= +i.min_date && +o <= +i.max_date) s = Math.floor(t.columnIndexByDate(o)),
            i.trace_x[s] || (s -= 1, i.rtl && (s = 0)),
            a = new Date(i.trace_x[s]),
            r = t.date.add(a, l, d);
            else {
                for (s = Math.floor(t.columnIndexByDate(o)), r = t.date[d + "_start"](new Date(i.min_date)), i.trace_x[s] && (r = t.date[d + "_start"](i.trace_x[s])); + r < +o;) {
                    ...
                    r = t._correct_dst_change(r, c, r, d),
                    t.date[d + "_start"] && (r = t.date[d + "_start"](r))
                }
    ...
    i.prototype = {
        ...
        _calculateDuration: function(t, e, i, n) {
            ...
            if (a[i]) s = Math.round((e - t) / (n * a[i]));
                ...
                for (var o = new Date(t), l = new Date(e); o.valueOf() < l.valueOf();) s += 1,
                o = r.add(o, n, i);
...
function(t, e, i) {
    ...
    function a(t, e) {
        this.argumentsHelper = e,
        this.$gantt = t,
        this._workingUnitsCache = new n
    }
    a.prototype = {
        units: ["year", "month", "week", "day", "hour", "minute"],
        _getUnitOrder: function(t) {
            for (var e = 0,
            i = this.units.length; e < i; e++) if (this.units[e] == t) return e
        },
        ...
        _getWorkUnitsBetweenGeneric: function(t, e, i, n) {
            ...
            var o, l, d = 0,
            c = null,
            h = !1; (o = r[i + "_start"](new Date(a))).valueOf() != a.valueOf() && (h = !0);
            var u = !1; (l = r[i + "_start"](new Date(e))).valueOf() != e.valueOf() && (u = !0);
            for (var _ = !1; a.valueOf() < s.valueOf();) _ = (c = this._nextDate(a, i, n)).valueOf() > s.valueOf(),
            this._isWorkTime(a, i) && ((h || u && _) && (o = r[i + "_start"](new Date(a)), l = r.add(o, n, i)), h ? (h = !1, c = this._nextDate(o, i, n), d += (l.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf())) : u && _ ? (u = !1, d += (s.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf())) : d++),
            a = c;
            return d
        },
        ...
        _getWorkHoursForRange: function(t, e) {
            for (var i = 0,
            n = new Date(t), r = new Date(e); n.valueOf() < r.valueOf();) this._isWorkTime(n, "day") && (i += this._getHoursPerDay(n)),
        ...
        _tryChangeCalendarSettings: function(t) {
            ...
            return t(),
            !this._isEmptyCalendar(this._getCalendar()) || (this.$gantt.assert(!1, "Invalid calendar settings, no worktime available"), this._setCalendar(JSON.parse(e)), this._workingUnitsCache.clear(), !1)
        },
        _isEmptyCalendar: function(t) {
            var e = !1,
            i = [],
            n = !0;
            for (var r in t.dates) e |= !!t.dates[r],
            i.push(r);
            var a = [];
        ...
        calculateDuration: function() {
            ...
            if (!t.unit) return ! 1;
            var e = 0;
            return e = "hour" == t.unit ? this._getWorkUnitsBetweenHours(t.start_date, t.end_date, t.unit, t.step) : this._getWorkUnitsBetweenGeneric(t.start_date, t.end_date, t.unit, t.step),
            Math.round(e)
        },
        hasDuration: function() {
            var t = this.argumentsHelper.getDurationArguments.apply(this.argumentsHelper, arguments),
        ...
        _getClosestWorkTime: function(t) {
            ...
            for (var d = this._getUnitOrder(e), c = this.units[d - 1]; ! this._isWorkTime(i, e);) {
                if (c && !this._isWorkTime(i, c)) {
                    ...
                    h.date = i,
                    h.unit = c,
                    i = this._getClosestWorkTime(h)
                }
                o && (i = a ? n: r, l *= -1);
                var u = i.getTimezoneOffset();
                if (i = this.$gantt.date.add(i, l, e), i = this.$gantt._correct_dst_change(i, u, l, e), this.$gantt.date[e + "_start"] && (i = this.$gantt.date[e + "_start"](i)), o && (a ? n = i: r = i), a = !a, ++s > 3e3) return this.$gantt.assert(!1, "Invalid working time check"),
                !1
            }
            return i != r && "past" != t.dir || (i = this.$gantt.date.add(i, 1, e)),
            i
        }
    },
    t.exports = a
...
function(t, e, i) {
    ...
    s.prototype = {
        ...
        _getDayHoursForMultiple: function(t, e) {
            ...
            !0) ? (n ? (i[r] = s, i[r + 1] = s + 1, r += 2) : i[r - 1] += 1, n = !1) : n || (n = !0),
        ...
        mergeCalendars: function() {
            ...
            for (t = 0; t < 7; t++) i = this._getDayHoursForMultiple(n, r),
        ...
        createCalendar: function(t) {
            ...
            return n.mixin(o, s),
            o._tryChangeCalendarSettings(function() {}) ? o: null
        },
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        t.load = function(e, i, n) {
            ...
            var r = "json",
            a = null;
            arguments.length >= 3 ? (r = i, a = n) : "string" == typeof arguments[1] ? r = arguments[1] : "function" == typeof arguments[1] && (a = arguments[1]),
            this._load_type = r,
        ...
        t._load_collections = function(t) {
            ...
            for (var i in t) if (t.hasOwnProperty(i)) {
                ...
                for (var a = 0; a < n.length; a++) {
                    var s = n[a],
                    o = this.copy(s);
                    for (var l in o.key = o.value,
                    s) if (s.hasOwnProperty(l)) {
        ...
        t.xml = {
            ...
            _getCollections: function(e) {
                for (var i = {},
                n = t.ajax.xpath("//coll_options", e), r = 0; r < n.length; r++) for (var a = i[n[r].getAttribute("for")] = [], s = t.ajax.xpath(".//item", n[r]), o = 0; o < s.length; o++) {
            ...
            parse: function(e, i) {
                i = this._getXML(e, i);
                for (var n = {},
                r = n.data = [], a = t.ajax.xpath("//task", i), s = 0; s < a.length; s++) r[s] = this._xmlNodeToJSON(a[s]);
        ...
        t.oldxml = {
            parse: function(e, i) {
                ...
                for (s = 0; s < a.length; s++) { (l = t.xml._xmlNodeToJSON(a[s], !0)).id = "project-" + l.id,
                    r.push(l)
                }
                for (s = 0; s < r.length; s++) {
                    var l; (l = r[s]).start_date = l.startdate || l.est,
...
function(t, e) {
    t.exports = function(t) {
        ...
        function s(e) {
            ...
            a = t.getTaskType(i.type); (a == n.task && r == n.project || a == n.project && r == n.task) && (i.type = r, t.updateTask(e))
        }
        function o(e) {
        ...
        t.attachEvent("onAfterTaskAdd", e(i)),
        t.attachEvent("onAfterTaskUpdate", e(i)),
...
function(t, e) {
    t.exports = function(t) {
        ...
        function() {
            t.attachEvent("onBeforeDataRender", e(i)),
            t.attachEvent("onAfterTaskUpdate", e(r)),
            t.attachEvent("onAfterTaskAdd", e(function(e, i) {
...
function(t, e) {
    function i(t) {
        ...
        function n(i, n) {
            for (var r, a = n.join("_") + "_" + i, s = {},
            o = 0; o < n.length; o++) s[n[o]] = !0;
        ...
        function r(n, r, a, s) {
            ...
            return e[o] ? e[o] : e[o] = function(e, n, r, a) {
                for (var s = i(e, n), o = r.unit, l = {},
                d = 0; d < s.length; d++) for (var c = s[d], h = t.date[o + "_start"](new Date(c.start_date)); h < c.end_date;) {
                    var u = h;
                ...
                for (var f, g, p = [], v = a.$getConfig(), d = 0; d < r.trace_x.length; d++) f = new Date(r.trace_x[d]),
                g = t.date.add(f, 1, o),
                ((s = l[f.valueOf()] || []).length || v.resource_render_empty_cells) && p.push({
                    start_date: f,
                    end_date: g,
                    tasks: s
                });
            ...
            renderLine: function(t, e) {
                for (var i = e.$getConfig(), n = e.$getTemplates(), a = r(i.resource_property, t.id, e.getScale(), e), s = [], o = 0; o < a.length; o++) {
                    ...
                    if (d || c) {
                        ...
                        u.style.cssText = ["left:" + h.left + "px", "width:" + h.width + "px", "height:" + (i.row_height - 1) + "px", "line-height:" + (i.row_height - 1) + "px", "top:" + h.top + "px"].join(";"),
                        c && (u.innerHTML = c),
                        s.push(u)
                    }
                }
                var _ = null;
                if (s.length) for (_ = document.createElement("div"), o = 0; o < s.length; o++) _.appendChild(s[o]);
                return _
            },
            filterTasks: i
        }
        ...
        t.fn.dhx_gantt = function(i) {
            if ("string" != typeof(i = i || {})) {
                ...
                return this.each(function() {
                    if (this && this.getAttribute) if (this.gantt || window.gantt.$root == this) n.push("object" == typeof this.gantt ? this.gantt: window.gantt);
                    else {
    ...
    function i(t) {
        ...
        function(t, e) {
            if (i) s(t);
                ...
                i = !1,
                e || this.render(),
                o && (this._dp.setUpdateMode(r), this._dp.setGanttMode("tasks"), this._dp.sendData(), this._dp.setGanttMode("links"), this._dp.sendData())
            }
        }
    }
    t.exports = function(t) {
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        function p() {
            ...
            s && !y ? s = 0 : s < 0 && !k ? s = 0 : s > 0 && k + y >= b && (s = 0);
...
function(t, e, i) {
    ...
    a.prototype = {
        setTransactionMode: function(t, e) {
            "object" == typeof t ? (this._tMode = t.mode || this._tMode, n.defined(t.headers) && (this._headers = t.headers), n.defined(t.payload) && (this._payload = t.payload)) : (this._tMode = t, this._tSend = e),
        ...
        _sendData: function(t, e) {
            if (t) {
                ...
                if ("GET" == this._tMode) r.query({
                    ...
                    u = (l = "", "post");
                    "inserted" == c ? l = this.serialize(t, e) : "deleted" == c ? (u = "DELETE", h = h + ("/" == h.slice( - 1) ? "": "/") + e) : (u = "PUT", l = this.serialize(t, e), h = h + ("/" == h.slice( - 1) ? "": "/") + e),
        ...
        sendAllData: function() {
            if (this.updatedRows.length) {
                ...
                else for (e = 0; e < this.updatedRows.length; e++) if (!this._in_progress[this.updatedRows[e]]) {
        ...
        afterUpdateCallback: function(t, e, i, n) {
            ...
            "wait" != this._in_progress[r] ? (a && this.obj.setUserData(t, this.action_param, ""), delete this._in_progress[r]) : (delete this._in_progress[r], this.setUpdated(e, !0, this.obj.getUserData(t, this.action_param))),
        ...
        afterUpdate: function(t, e, i) {
            ...
            if (window.JSON) {
                ...
                if (r) {
                    ...
                    s = r.sid || i[0],
                    o = r.tid || i[0];
                    return t.afterUpdateCallback(s, o, a, r),
...
function(t, e, i) {
    ...
    function a(t, e, i, n) {
        ...
        "links" == n && (r.delete = this.deleteLink, r.isExist = this.isLinkExists),
        r.isExist.call(this, e) && r.delete.call(this, e)
    }
    t.exports = function(t, e) {
        e.attachEvent("insertCallback", n.bind(r, t)),
        e.attachEvent("updateCallback", n.bind(a, t)),
        e.attachEvent("deleteCallback", n.bind(a, t))
    }
},
function(t, e, i) {
    var n = i(74),
    ...
    t.exports = function(t) {
        ...
        t._dp_init = function(o) {
            t.assert(!this._dp, "The dataProcessor is already attached to this gantt instance"),
            o.setTransactionMode("POST", !0),
            o.serverProcessor += ( - 1 != o.serverProcessor.indexOf("?") ? "&": "?") + "editing=true",
            o._serverProcessor = o.serverProcessor,
            o.$gantt = this,
            o.styles = {
            ...
            function(t, i) {
                i.setGanttMode = function(t) {
                    ...
                    i._in_progress = n._in_progress,
                    i._invalid = n._invalid,
                    i.updatedRows = n.updatedRows,
                    i.modes = e,
                    i._ganttMode = t
                },
                e = i.afterUpdate,
                i.afterUpdate = function() {
                    ...
                    var n = i._ganttMode,
                    r = t.filePath;
                    n = "REST" != this._tMode ? -1 != r.indexOf("gantt_mode=links") ? "links": "tasks": r.indexOf("/link") > r.indexOf("/task") ? "links": "tasks",
                    i.setGanttMode(n);
                    var a = e.apply(i, arguments);
                    return i.setGanttMode(n),
                    a
                },
                i._getRowData = t.bind(function(e, n) {
                    ...
                    return d.$no_start && (a.start_date = "", a.duration = ""),
                    d.$no_end && (a.end_date = "", a.duration = ""),
                    s[i.action_param] = this.getUserData(e, i.action_param),
                    s
                },
                t)
            }.call(this, t, o),
            ...
            function(t, e) {
                ...
                s.push(this.attachEvent("onAfterTaskAdd",
                function(t, i) {
                    e.setGanttMode("tasks"),
                    e.setUpdated(t, !0, "inserted")
                })),
                s.push(this.attachEvent("onAfterTaskUpdate",
                function(i, n) {
                    e.setGanttMode("tasks"),
                    e.setUpdated(i, !0),
                ...
                var r = i(17),
                a = {};
                s.push(this.attachEvent("onBeforeTaskDelete",
                function(e, i) {
                ...
                s.push(this.attachEvent("onAfterTaskDelete",
                function(i, r) {
                ...
                s.push(this.attachEvent("onAfterLinkUpdate",
                function(t, i) {
                    e.setGanttMode("links"),
                    e.setUpdated(t, !0)
                })),
                s.push(this.attachEvent("onAfterLinkAdd",
                function(t, i) {
                    e.setGanttMode("links"),
                    e.setUpdated(t, !0, "inserted")
                })),
                s.push(this.attachEvent("onAfterLinkDelete",
                function(t, i) {
                    e.setGanttMode("links"),
                    !n(t) && e.setUpdated(t, !0, "deleted")
                })),
                s.push(this.attachEvent("onRowDragEnd",
                function(e, i) {
                    t._sendTaskOrder(e, t.getTask(e))
                }));
                var o = null,
                l = null;
                s.push(this.attachEvent("onTaskIdChange",
                function(i, n) {
                    if (e._waitMode) {
                ...
                function() { (o || l) && (t.batchUpdate(function() {
            ...
            o.attachEvent("onDestroy",
            function() { !
                function(t, i) {
                    delete i.$gantt,
                    delete i.setGanttMode,
                    delete i._getRowData,
                    i.afterUpdate = e,
                    delete t._dp,
                    delete t._change_id,
                    delete t._row_style,
...
function(t, e) {
    t.exports = {
        bindDataStore: function(t, e) {
            ...
            i.attachEvent("onItemOpen",
            function() {
                e.render()
            }),
            i.attachEvent("onItemClose",
            function() {
                e.render()
            }),
            i.attachEvent("onIdChange",
            function(r, s) {
...
function(t, e) {
    t.exports = function(t) {
        ...
        }),
        {
            ...
            unselect: function(t) { (t = t || e) && (e = null, this._skip_refresh || (this.refresh(t), this.callEvent("onAfterUnselect", [t])))
            }
        }
    }
},
function(t, e, i) {
    ...
    o.prototype = r.mixin({
        _buildTree: function(t) {
            for (var e = null,
            i = this.$getRootId(), n = 0, a = t.length; n < a; n++) e = t[n],
            this.setParent(e, this.getParent(e) || i);
            for (n = 0, a = t.length; n < a; n++) e = t[n],
            this._add_branch(e),
        ...
        _addItemInner: function(t, e) {
            ...
            1 * n !== n && (n = void 0),
            s.prototype._addItemInner.call(this, t, n),
            this.setParent(t, i),
        ...
        _removeItemInner: function(t) {
            ...
            for (var i = 0; i < e.length; i++) this._move_branch(e[i], this.getParent(e[i]), null),
        ...
        move: function(t, e, i) {
            ...
            if (t != i) {
                ...
                if (!1 !== this.callEvent("onBeforeItemMove", [t, i, e])) {
                    ...
                    (s = this.getChildren(i))[e] ? s = s.slice(0, e).concat([t]).concat(s.slice(e)) : s.push(t),
                    this.setParent(r, i),
                    this._branches[i] = s;
        ...
        clearAll: function() {
            this._branches = {},
            s.prototype.clearAll.call(this)
        },
        ...
        eachParent: function(t, e) {
            for (var i = e,
            n = this.getParent(i); this.exists(n);) i = this.getItem(n),
            t.call(this, i),
            n = this.getParent(i)
        },
        ...
        sort: function(t, e, i) {
            ...
            if (a) {
                ...
                s.sort(n);
                for (o = 0; o < s.length; o++) a[o] = s[o].id,
                this.sort(t, e, a[o])
            }
        },
        filter: function(t) {
        ...
        destructor: function() {
            s.prototype.destructor.call(this),
            this._branches = null
        }
    },
    s.prototype),
        ...
        return {
            createDatastore: function(t) {
                ...
                if (this.mixin(n, l(n)), t.name) {
                    this.$services.setService("datastore:" + t.name,
                    function() {
                        return n
                    });
                    var r = this.$services.getService("datastores");
                    r || (r = [], this.$services.setService("datastores",
                    function() {
                        return r
                    })),
                    r.push(t.name),
                    d.bindDataStore(t.name, this)
                }
                return n
            },
            ...
            refreshData: function() {
                ...
                for (var e = c.call(this), i = 0; i < e.length; i++) e[i].refresh(); (t.x || t.y) && this.scrollTo(t.x, t.y),
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        function h() {
            for (var e = null,
            i = t.$data.tasksStore.getItems(), n = 0, r = i.length; n < r; n++)(e = i[n]).$source = [],
            e.$target = [];
        ...
        function(e, i, n) {
            if ("delete" == n && t._update_flags(e, null), !t.$services.getService("state").getState("batchUpdate").batch_update) {
                if (t.config.fit_tasks && "paint" !== n) {
                    ...
                    a(t);
                    var s = t.getState();
                    if ( + r.min_date != +s.min_date || +r.max_date != +s.max_date) return t.render(),
                    t.callEvent("onScaleAdjusted", []),
                    !0
                }
        ...
        o.attachEvent("onAfterAdd",
        function(t, e) {
            d(e)
        }),
        o.attachEvent("onAfterUpdate",
        function(t, e) {
            h()
        }),
        o.attachEvent("onAfterDelete",
        function(t, e) {
            c(e)
        }),
        o.attachEvent("onBeforeIdChange",
        function(e, i) {
            c(t.mixin({
                id: e
            },
            t.$data.linksStore.getItem(i))),
            d(t.$data.linksStore.getItem(i))
        }),
        o.attachEvent("onFilterItem",
        function(e, i) {
        ...
        function() {
            ...
            function(e, i) {
                n[e] && t.$data.linksStore.silent(function() {
                    for (var i in n[e]) t.$data.linksStore.removeItem(i),
                    c(n[e][i]);
                    n[e] = null
                })
            })
    ...
    t.exports = function() {
        ...
        return {
            ...
            scrollTo: function(t, e) {
                ...
                this.callEvent("onGanttScroll", [s.position, o.position, d.position, l.position])
            },
            showDate: function(t) {
        ...
        return {
            ...
            onCreated: function(e) {
                ...
                function() {
                    ...
                    if (a) {
                        ...
                        if (i) {
                            var o = a._getColsTotalWidth(); ! 1 !== o && (t.config.grid_width = o),
                        ...
                        if (a.$config.hidden = a.$parent.$config.hidden = !s, !a.$config.hidden) {
                            ...
                            if (l[0] && t.config.grid_width < l[0] && (t.config.grid_width = l[0]), l[1] && t.config.grid_width > l[1] && (t.config.grid_width = l[1]), r && t.config.show_chart) if (a.$config.width = t.config.grid_width - 1, i) a.$parent.$config.width = t.config.grid_width,
                            ...
                            else r && n.isChildOf(r.$task, e.$view) && (a.$config.original_grid_width = t.config.grid_width),
            ...
            onInitialized: function(e) {
                ...
                if (n.resizer) {
                    ...
                    s.attachEvent("onResize",
                    function(e, i) {
                        var n = a ? e: i;
                        return t.callEvent("onGridResize", [r, n])
                    }),
                    s.attachEvent("onResizeEnd",
                    function(e, i, n, r) {
                        var s = a ? e: i,
                        o = a ? n: r,
                        l = t.$ui.getView("grid"),
                        ...
                        return c && (t.config.grid_width = o),
                        c
                    })
                }
            },
    ...
    r = function(t, e) {
        ...
        u.attachEvent("onBeforeDragStart", e.bind(function(i, r) {
            ...
            if (n.locateClassName(a, "gantt_link_point")) {
                ...
                s = l;
                var d = e.getTask(l);
                if (e.isReadonly(d)) return g(),
                !1;
                return this._dir_start = _(d, !!o, 0, t.$getConfig(), !0),
                !0
            }
            return ! 1
        },
        this)),
        u.attachEvent("onAfterDragStart", e.bind(function(t, i) {
            e.config.touch && e.refreshData(),
            f(u.config.marker)
        },
        this)),
        u.attachEvent("onDragMove", e.bind(function(s, o) {
            var d = u.config,
            c = u.getPosition(o); !
            function(t, e) {
            ...
            if (h && (y = !n.locateClassName(o, "task_end_date"), h = !!k), r = k, i = h, a = y, h) {
                ...
                w = 0;
                x && (w = Math.floor(x.offsetWidth / 2)),
                this._dir_end = _(b, !!a, w, $)
            } else this._dir_end = n.getRelativeEventPosition(o, t.$task_data);
            var S = !(v == h && g == k && m == y);
            return S && (g && e.refreshTask(g, !1), k && e.refreshTask(k, !1)),
            S && f(d.marker),
            function(i, n, r, a) {
                var s = function() {
            ...
            } (this._dir_start.x, this._dir_start.y, this._dir_end.x, this._dir_end.y),
            !0
        },
        this)),
        u.attachEvent("onDragEnd", e.bind(function() {
            var t = l();
            ...
            u._direction && (u._direction.parentNode && u._direction.parentNode.removeChild(u._direction), u._direction = null)
        },
        this))
    };
    t.exports = {
                    ...
                    return t = function(t, e) {
                        ...
                        return {
                            ...
                            set_actions: function() {
                                ...
                                this)),
                                this._domEvents.attach(i, "mouseup", e.bind(function(t) {
                            ...
                            _resize: function(i, n, r) {
                                ...
                                r.left ? (i.start_date = e.dateFromPos(s.start + n), i.start_date || (i.start_date = new Date(e.getState().min_date))) : (i.end_date = e.dateFromPos(s.end + n), i.end_date || (i.end_date = new Date(e.getState().max_date))),
                            ...
                            _find_max_shift: function(t, i) {
                                ...
                                for (var r in t) {
                                    ...
                                    if (o.end + i > d) {
                                        var c = d - o.end; (c < n || void 0 === n) && (n = c)
                                    } else if (o.start + i < l) {
                                        var h = l - o.start; (h < n || void 0 === n) && (n = h)
                                    }
                                }
                                return n
                            },
                            ...
                            on_mouse_move: function(t) {
                                if (this.drag.start_drag) {
                                    ...
                                    s = this.drag.start_drag.start_y; (Date.now() - this.drag.timestamp > 50 || this._is_number(r) && this._is_number(s) && this._mouse_position_change({
                                        x: r,
                                        y: s
                                    },
                            ...
                            on_mouse_down: function(i, r) {
                                if (2 != i.button || void 0 === i.button) {
                                    ...
                                    if (e.isTaskExists(s) && (o = e.getTask(s)), !e.isReadonly(o) && !this.drag.mode) {
                                        ...
                                        if (d) if (d.mode && d.mode != a.drag_mode.ignore && a["drag_" + d.mode]) {
                                            if (s = e.locate(r), o = e.copy(e.getTask(s) || {}), e.isReadonly(o)) return this.clear_drag_state(),
                                            !1;
                            ...
                            _fix_dnd_scale_time: function(i, n) {
                                ...
                                r.round_dnd_dates || (a = "minute", s = r.time_step),
                            ...
                            on_mouse_up: function(i) {
                                ...
                                if (n.mode && n.id) {
                                    ...
                                    a = e.getTask(n.id),
                                    s = this.dragMultiple;
                                    if (this._finalize_mouse_up(n.id, r, n, i), e.isSummaryTask(a) && r.drag_project && n.mode == r.drag_mode.move) for (var o in s) this._finalize_mouse_up(s[o].id, r, s[o], i)
                                }
                                this.clear_drag_state()
                            },
        ...
        return {
            ...
            _attachDomEvents: function(t) {
                ...
                this._mouseDelegates.delegate("doubleclick", "gantt_link_point", t.bind(function(t, i, n) {
                    ...
                    a = null;
                    return n.parentNode && s.getClassName(n.parentNode) && (a = s.getClassName(n.parentNode).indexOf("_left") > -1 ? r.$target[0] : r.$source[0]),
                    a && e.call(this, a, t),
                    !1
                },
                t), this.$task)
    ...
    t.exports = {
        init: function(t, e) {
            ...
            if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                ...
                r.attachEvent("onBeforeDragStart", t.bind(function(i, n) {
                    var o = a(n);
                    if (!o) return ! 1;
                ...
                r.lastTaskOfLevel = function(t) {
                    for (var e = null,
                    i = s().getItems(), n = 0, r = i.length; n < r; n++) i[n].$level == t && (e = i[n]);
                    return e ? e.id: null
                },
                r._getGridPos = t.bind(function(t) {
                    ...
                    return o > i.y + d - l.row_height && (o = i.y + d - l.row_height),
                    i.x = a,
                    i.y = o,
                    i
                },
                ...
                r.attachEvent("onDragMove", t.bind(function(t, i) {
                    ...
                    if (l.exists(h) || (h = r.lastTaskOfLevel(o.order_branch_free ? d.$level: 0)) == r.config.id && (h = null), l.exists(h)) {
                        ...
                        if (l.getIndexById(_.id) * o.row_height + o.row_height / 2 < c) {
                            ...
                            if (!l.hasChild(_.id)) return _.$open = !0,
                            void l.move(d.id, -1, _.id);
                            if (l.getIndexById(_.id) || o.row_height / 3 < c) return
                        }
                        f = l.getIndexById(_.id);
                        for (var v = l.getIdByIndex(f - 1), m = l.getItem(v), k = 1; (!m || m.id == _.id) && f - k >= 0;) v = l.getIdByIndex(f - k),
                        m = l.getItem(v),
                        k++;
                        if (d.id == _.id) return;
                ...
                r.attachEvent("onDragEnd", t.bind(function() {
                    ...
                    !1 === this.callEvent("onBeforeRowDragEnd", [r.config.id, r.config.parent, r.config.index]) ? (t.move(r.config.id, r.config.index, r.config.parent), e.$drop_target = null) : this.callEvent("onRowDragEnd", [r.config.id, e.$drop_target]),
                    t.refresh(e.id)
                },
                t))
            }
...
function(t, e, i) {
    ...
    function(t) {
        return {
            ...
            onDestroyed: function(e) {
                t.ext.inlineEditors.destructor(),
            ...
            initEvents: function(t, e) {
                this._mouseDelegates.delegate("click", "gantt_row", e.bind(function(i, n, r) {
                    ...
                    if (null !== n) {
                        ...
                        a.scroll_on_click && !e._is_icon_open_click(i) && this.showDate(s.start_date),
                ...
                this._mouseDelegates.delegate("click", "gantt_grid_head_cell", e.bind(function(i, n, r) {
                    ...
                    if (e.callEvent("onGridHeaderClick", [a, i])) {
                        ...
                        if ("add" != a) {
                            if (s.sort) {
                                for (var o, l = a,
                                d = 0; d < s.columns.length; d++) if (s.columns[d].name == a) {
                                    o = s.columns[d];
                                    break
                                }
    ...
    t.exports = function(t) {
        return function(e, i) {
            ...
            for (var l = [], d = 0; d < r.length; d++) {
                ...
                f = r[d];
                "add" == f.name ? (e['ishide']?(h = "<div " + (k = t._waiAria.gridAddButtonAttrString(f)) + " class='gantt_add'></div>", u = ""):h="") : (h = f.template ? f.template(e) : e[f.name], n.isDate(h) && (h = s.date_grid(h, e)), u = h, h = "<div class='gantt_tree_content'>" + h + "</div>");
                ...
                p.push(h),
                a.rtl && (p = p.reverse()),
                c = "<div class='" + g + "' data-column-index='" + d + "' data-column-name='" + f.name + "' style='" + m + "' " + k + ">" + p.join("") + "</div>",
                l.push(c)
            }
            ...
            var $ = i.getItemHeight();
            return b.style.height = $ + "px",
            b.style.lineHeight = $ + "px",
            a.smart_rendering && (b.style.position = "absolute", b.style.left = "0px", b.style.top = i.getItemTop(e.id) + "px"),
            i.$config.item_attribute && b.setAttribute(i.$config.item_attribute, e.id),
            t._waiAria.taskRowAttr(e, b),
            b.innerHTML = l.join(""),
            b
        }
    }
    ...
    t.exports = function(t) {
        var e = {
            ...
            render_line: function(t, e, i) {
                ...
                return s.style.cssText = ["height:" + a.height + "px", "width:" + a.width + "px", "margin-top:" + a.marginTop + "px", "margin-left:" + a.marginLeft + "px"].join(";"),
        ...
        i = {
            ...
            get_points: function(i, n) {
                ...
                h = r.e_x > r.x;
                if (c.from_start && c.to_start) this.point_to(l.left, d),
                h ? (this.point_to(l.down, s), this.point_to(l.right, o)) : (this.point_to(l.right, o), this.point_to(l.down, s)),
                this.point_to(l.right, d);
                else if (!c.from_start && c.to_start) if (h = r.e_x > r.x + 2 * d, this.point_to(l.right, d), h) o -= d,
                this.point_to(l.down, s),
            ...
            get_line_type: function(e, i) {
                ...
                r = !1,
                a = !1;
                return e.type == n.start_to_start ? r = a = !0 : e.type == n.finish_to_finish ? r = a = !1 : e.type == n.finish_to_start ? (r = !1, a = !0) : e.type == n.start_to_finish ? (r = !0, a = !1) : t.assert(!1, "Invalid link type"),
                i.rtl && (r = !r, a = !a),
                {
                    from_start: r,
                    to_start: a
        ...
        return function(n, r) {
            ...
            u && (h += " " + u),
            a.highlight_critical_path && t.isCriticalLink && t.isCriticalLink(n) && (h += " gantt_critical_link"),
            c.className = h,
            r.$config.link_attribute && c.setAttribute(r.$config.link_attribute, n.id);
            for (var _ = 0; _ < d.length; _++) {
                _ == d.length - 1 && (d[_].size -= a.link_arrow_size);
                var f = e.render_line(d[_], d[_ + 1], r);
                n.color && (f.firstChild.style.backgroundColor = n.color),
                c.appendChild(f)
            }
            ...
            p = function(t, i, n) {
                ...
                return a.style.cssText = ["top:" + s + "px", "left:" + o + "px"].join(";"),
                a.className = c,
                a
            } (l[l.length - 1], g, r);
            return n.color && (p.style.borderColor = n.color),
            c.appendChild(p),
            t._waiAria.linkAttr(n, c),
            c
        }
    }
},
        ...
        return function(e, i) {
            ...
            if (n.show_task_cells) for (var l = 0; l < s; l++) {
                ...
                if (d > 0) {
                    ...
                    h.style.width = d + "px",
                    c = "gantt_task_cell" + (l == s - 1 ? " gantt_last_cell": ""),
                    (_ = r.task_cell_class(e, a.trace_x[l])) && (c += " " + _),
                    h.className = c,
                    o.appendChild(h)
                }
            }
            ...
            return i.$config.rowStore.getSelectedId() == e.id && (f += " gantt_selected"),
            o.className = f,
            n.smart_rendering && (o.style.position = "absolute", o.style.top = i.getItemTop(e.id) + "px", o.style.width = "100%"),
            o.style.height = n.row_height + "px",
            i.$config.item_attribute && o.setAttribute(i.$config.item_attribute, e.id),
            o
        }
    }
},
            ...
            if (t.isSplitTask(i)) {
                ...
                for (var r = document.createElement("div"), a = t.getTaskPosition(i), s = t.getChildren(i.id), o = 0; o < s.length; o++) {
                    ...
                    if (d) {
                        ...
                        d.style.top = a.top + c + "px",
                        d.className += " gantt_split_child",
                        r.appendChild(d)
                    }
                }
                return r
...
function(t, e, i) {
    t.exports = function(t) {
        ...
        n.mixin(r.prototype, {
            ...
            save: function(e, i, n) {
                var r = o(t.getTask(e), this.get_value(e, i, n)); (r.add.length || r.remove.length) && t.batchUpdate(function() {
...
function(t, e, i) {
    t.exports = function(t) {
        ...
        n.mixin(r.prototype, {
            show: function(t, e, i, n) {
                for (var r = "<div><select name='" + e.name + "'>",
                a = [], s = i.options || [], o = 0; o < s.length; o++) a.push("<option value='" + i.options[o].key + "'>" + s[o].label + "</option>");
                r += a.join("") + "</select></div>",
                n.innerHTML = r
            },
            get_input: function(t) {
    ...
    t.exports = {
        init: function(t, e) {
            ...
            function(e, r) {
                ...
                case d.SPACE:
                    t.isVisible() && (h = !0),
                    o && !t.isVisible() && (i.startEdit(s.id, s.columnName), r.preventDefault(), h = !0);
                    break;
                case d.DELETE:
...
function(t, e, i) {
    ...
    function(t) {
        ...
        function e(e, i, n, r) {
            ...
            s._scrollHorizontalHandler = a.bind(s._scrollHorizontalHandler, s),
            s._scrollVerticalHandler = a.bind(s._scrollVerticalHandler, s),
            s._outerScrollVerticalHandler = a.bind(s._outerScrollVerticalHandler, s),
            s._outerScrollHorizontalHandler = a.bind(s._outerScrollHorizontalHandler, s),
            s._mouseWheelHandler = a.bind(s._mouseWheelHandler, s),
            this.$config.hidden = !0;
            var o = r.config.scroll_size;
            return r.env.isIE && (o += 1),
            this._isHorizontal() ? (s.$config.height = o, s.$parent.$config.height = o) : (s.$config.width = o, s.$parent.$config.width = o),
        ...
        e.prototype._getScrollSize = function() {
            for (var t, e = 0,
            i = 0,
            n = this._isHorizontal(), r = this._getLinkedViews(), a = n ? "scrollWidth": "scrollHeight", s = n ? "contentX": "contentY", o = n ? "x": "y", l = this._getScrollOffset(), d = 0; d < r.length; d++) if ((t = r[d]) && t.$content && t.$content.getSize && !t.$config.hidden) {
                var c, h = t.$content.getSize();
                if (c = h.hasOwnProperty(a) ? h[a] : h[s], l) h[s] > h[o] && h[s] > e && c > h[o] - l + 2 && (e = c + (n ? 0 : 2), i = h[o]);
                else {
                    var u = Math.max(h[s] - c, 0); (c += u) > Math.max(h[o] - u, 0) && c > e && (e = c, i = h[o])
                }
            }
            return {
                outerScroll: i,
...
function(t, e) {
    t.exports = function(t) {
        ...
        function r(r, a, s) {
            ...
            var o = a.filter;
            return s && s.setAttribute(e.config().layer_attribute, !0),
            n[r] = {
                ...
                clear: function(t) {
                    this.rendered = i[r] = {},
                    a.append || this.clear_container(t)
                },
                clear_container: function(t) { (t = t || s) && (t.innerHTML = "")
                },
                render_items: function(t, e) {
                    ...
                    this.clear(e);
                    for (var n = 0,
                    r = t.length; n < r; n++) this.render_item(t[n], i);
                    e.appendChild(i)
                },
                ...
                var l = {
                    ...
                    _add: function(t) {
                        ...
                        for (var i = this.container(), s = this.tempCollection, o = 0; o < s.length; o++) if (t = s[o], this.container() || t && t.container && a.isChildOf(t.container, document.body)) {
                            ...
                            d = t.id,
                            c = t.topmost;
                            if (!l.parentNode) if (c) i.appendChild(l);
                            else {
                    ...
                    addLayer: function(t) {
                        return t && ("function" == typeof t && (t = {
                            renderer: t
                        }), void 0 === t.filter ? t.filter = s(o || []) : t.filter instanceof Array && (t.filter.push(o), t.filter = s(t.filter)), t.container || (t.container = document.createElement("div"))),
                        this._add(t),
                        t ? t.id: void 0
                    },
    ...
    t.exports = function(t) {
        ...
        return {
            ...
            createDataRender: function(i) {
                ...
                return t.$services.setService("layer:" + n,
                function() {
                    return s
                }),
                t.attachEvent("onGanttReady",
...
function(t, e, i) {
    var n = function(t) {
        return function(e) {
            ...
            function r(t) { (t = t || window.event).target || t.srcElement;
                var n = e.locate(t),
                r = s(t, i.click),
                a = !0;
            ...
            function l(t) { (t = t || window.event).target || t.srcElement;
                var n = e.locate(t),
                r = s(t, i.doubleclick),
            ...
            function h(t) {
                c.detachAll(),
                t && (c.attach(t, "click", r), c.attach(t, "dblclick", l), c.attach(t, "mousemove", d), c.attach(t, "contextmenu", a))
            }
            return {
                reset: h,
    ...
    t.exports = {
        createFactory: function(t) {
            ...
            function a(a, s, o, l) {
                ...
                "resizer" != a || o.mode || (l.$config.cols ? o.mode = "x": o.mode = "y"),
                "viewcell" != a || "scrollbar" != o.view || o.scroll || (l.$config.cols ? o.scroll = "y": o.scroll = "x"),
                (o = n.copy(o)).id || i[o.view] || (o.id = o.view),
                o.id && !o.css && (o.css = o.id + "_cell");
                var c = new d.create(s, o, this, t);
                return d.configure && d.configure(c),
                r(c, l),
                c.$id || (c.$id = o.id || t.uid()),
                c.$parent || "object" != typeof s || (c.$parent = s),
                c.$config || (c.$config = o),
                i[c.$id] && (c.$id = t.uid()),
                i[c.$id] = c,
                c
...
function(t, e, i) {
    ...
    t.exports = {
        init: function(t) {
            ...
            i.registerView("cell", s),
            i.registerView("resizer", c),
            i.registerView("scrollbar", h),
            i.registerView("layout", o,
            function(t) {
                "main" === (t.$config ? t.$config.id: null) && e(t, w)
            }),
            i.registerView("viewcell", d),
            i.registerView("multiview", l),
            i.registerView("timeline", u,
            function(t) {
                "timeline" !== (t.$config ? t.$config.id: null) && "task" != t.$config.bind || e(t, x)
            }),
            i.registerView("grid", _,
            function(t) {
...
function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        function c(i, c, h) {
            var u = i.tagName ? i: function(i, s, o) {
                ...
                if (u += "</div>", c.innerHTML = u, i.content) {
                    ...
                    c.childNodes[i.title ? 1 : 0].appendChild(g)
                }
            ...
            return "top" == i.position ? u.style.top = "-3px": u.style.top = f + "px",
            u.style.left = _ + "px",
            u.onkeydown = s,
            g.focus(u),
            i.hidden && g.hide(u),
            t.callEvent("onMessagePopup", [u]),
            u
        }
        function h(t) {
            return c(t, !0, !1)
        ...
        var v = function(e, i, r, a) {
            ...
            default:
                return function(e) {
                    v.area || (v.area = document.createElement("div"), v.area.className = "gantt_message_area dhtmlx_message_area", v.area.style[v.position] = "5px", document.body.appendChild(v.area)),
                    v.hide(e.id);
                    var i = document.createElement("div");
                    ...
                    "bottom" == v.position && v.area.firstChild ? v.area.insertBefore(i, v.area.firstChild) : v.area.appendChild(i),
                    e.expire > 0 && (v.timers[e.id] = window.setTimeout(function() {
                        v.hide(e.id)
                    },
                    e.expire)),
                    v.pull[e.id] = i,
            ...
            initTemplates: function() {
                ...
                t.mixin(t.templates, {
                    ...
                    drag_link: function(e, i, n, r) {
                        ...
                        return n && (s += "<b> " + (n = t.getTask(n)).text + "</b> " + (r ? a.link_start: a.link_end) + "<br/>"),
                        s
                    },
        ...
        return i.prototype = {
            traceDragEvents: function(e, i) {
                ...
                this), r.bind(function(t) {
                    return t && t.preventDefault && t.preventDefault(),
                    (t || event).cancelBubble = !0,
                    !(!r.defined(this.config.updates_per_second) || a(this, this.config.updates_per_second)) || n(t)
                },
                this)),
                o = r.bind(function(n) {
                    return t.eventRemove(document.body, i.move, s),
                    t.eventRemove(document.body, i.up, o),
                    this.dragEnd(e)
                },
                this);
                t.event(document.body, i.move, s),
                t.event(document.body, i.up, o)
            },
    ...
    t.exports = function(t) {
        var e = {
            init: function() {
                ...
                r = 0; r < i.length; r++) n[i[r]] = r;
                for (i = e.date.month_full, n = e.date.month_full_hash = {},
                r = 0; r < i.length; r++) n[i[r]] = r
            },
            ...
            str_to_date: function(e, i) {
                for (var n = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);",
                r = e.match(/%[a-zA-Z]/g), a = 0; a < r.length; a++) switch (r[a]) {
                case "%j":
                case "%d":
                    n += "set[2]=temp[" + a + "]||1;";
                    break;
                ...
                if (a && (d.onreadystatechange = function() {
                    if (4 == d.readyState || c && 3 == d.readyState) {
                        ...
                        window.setTimeout(function() {
                            ...
                            o && (void 0 !== o.postData ? this.postLong(o.url, o.postData, s) : this.getLong(o.url, s)),
                            s = null,
                            d = null
                        },
                        1)
                    }
                }), "GET" != e || this.cache || (i += (i.indexOf("?") >= 0 ? "&": "?") + "dhxr" + (new Date).getTime() + "=1"), d.open(e, i, a), l) for (var h in l) d.setRequestHeader(h, l[h]);
...
function(t, e, i) {
    ...
    t.exports = function() {
        ...
        i(124)(t),
        t.$services = t.$inject(i(123)),
        t.config = t.$inject(i(122)),
        t.ajax = i(121)(t),
        t.date = i(120)(t);
        var e = i(119)(t);
        t.$services.setService("dnd",
        function() {
            return e
        }),
        t.$services.setService("config",
        function() {
            return t.config
        }),
        t.$services.setService("date",
        function() {
            return t.date
        }),
        t.$services.setService("locale",
        function() {
            return t.locale
        }),
        t.$services.setService("templates",
        function() {
            return t.templates
        });
        var n = i(118)(t);
        t.$services.setService("templateLoader",
        function() {
            return n
        }),
        i(3)(t);
        var r = new(i(117));
        r.registerProvider("global",
        function() {
            return {
        ...
        var o = i(115).init(t);
        t.$ui = o.factory,
        t.$ui.layers = o.render,
        t.$mouseEvents = o.mouseEvents,
        t.$services.setService("mouseEvents",
        function() {
            return t.$mouseEvents
        }),
        t.mixin(t, o.layersApi),
        i(84)(t),
