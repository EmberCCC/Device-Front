        ...
        return (
            <Header className='common_header_layout'>
                ...
                <div style={{display: 'flex', flex: 1, alignItems: 'center'}}>
                    {
                        this.props.isAuth && !this.props.ishome &&
                        <div style={{display: 'flex', flex: 1, alignItems: 'center'}}>
                            <LegacyIcon
                                className="trigger"
                    ...
                    {
                        this.props.ishome && <Button type='primary' style={{marginLeft: 25}}
                                                     onClick={this.handleInSystem}><ArrowRightOutlined
                            style={{padding: 0}}/>进入系统</Button>
                    }
                </div>
                ...
                <div className='global_header_right' style={{display: 'flex', alignItems: 'center', paddingRight: 25}}>
                    <div style={{display: 'inline-block', marginRight: '20px', cursor: 'pointer', color: '#C4C4C4'}}>
                        <i className='iconfont icon-alerm'
                           style={{marginRight: '5px', color: '#9D9D9D'}}/>{sessionStorage.getItem('username') || null}
                    </div>
