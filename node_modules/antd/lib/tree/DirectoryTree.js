...
function getIcon(props) {
  ...
  if (isLeaf) {
    return React.createElement(_icons.FileOutlined, null);
  }

  return expanded ? React.createElement(_icons.FolderOpenOutlined, null) : React.createElement(_icons.FolderOutlined, null);
}
