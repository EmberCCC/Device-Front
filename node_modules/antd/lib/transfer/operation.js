...
var Operation = function Operation(_ref) {
  ...
  return React.createElement("div", {
    ...
    onClick: moveToRight,
    icon: direction !== 'rtl' ? React.createElement(_icons.RightOutlined, null) : React.createElement(_icons.LeftOutlined, null)
  }, rightArrowText), React.createElement(_button["default"], {
    type: "primary",
    size: "small",
    disabled: disabled || !leftActive,
    onClick: moveToLeft,
    icon: direction !== 'rtl' ? React.createElement(_icons.LeftOutlined, null) : React.createElement(_icons.RightOutlined, null)
  }, leftArrowText));
};
