  ...
  function Cascader(props) {
    ...
    _this.renderCascader = function (_ref2, locale) {
      ...
      return React.createElement(_SizeContext["default"].Consumer, null, function (size) {
        ...
        var clearIcon = allowClear && !disabled && value.length > 0 || state.inputValue ? React.createElement(_icons.CloseCircleFilled, {
        ...
        }, suffixIcon)) || React.createElement(_icons.DownOutlined, {
          className: arrowCls
        });
        ...
        var expandIcon = React.createElement(_icons.RightOutlined, null);

        if (isRtlLayout) {
          expandIcon = React.createElement(_icons.LeftOutlined, null);
        }

        var loadingIcon = React.createElement("span", {
          className: "".concat(prefixCls, "-menu-item-loading-icon")
        }, React.createElement(_icons.RedoOutlined, {
          spin: true
        }));
