...
var Cell = function Cell(_ref) {
  ...
  if (bordered) {
    ...
    return React.createElement(Component, {
      className: classNames((_classNames = {}, _defineProperty(_classNames, "".concat(itemPrefixCls, "-item-label"), label), _defineProperty(_classNames, "".concat(itemPrefixCls, "-item-content"), content), _classNames), className),
      style: style,
      colSpan: span
    }, label || content);
  }
